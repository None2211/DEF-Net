...
class cswin_tiny(CSWin):
    def __init__(self, **kwargs):
        super(cswin_tiny, self).__init__(patch_size=4, embed_dim=64, depth=[1,2,21,1],num_heads=[2,4,8,16],in_chans=3,
                                         split_size =[1,2,7,7], drop_path_rate=0.3, use_chk=False, mlp_ratio=4.,
...
class cswin_small(CSWin):
    def __init__(self, **kwargs):
        super(cswin_small, self).__init__(patch_size=4, embed_dim=64, depth=[2,4,32,2],num_heads=[2,4,8,16],in_chans=3,
                                         split_size =[1,2,7,7], drop_path_rate=0.4, use_chk=False, mlp_ratio=4.,
                                         qkv_bias=True, qk_scale=None, drop_rate=0.,
                                         attn_drop_rate=0.,
                                         )
@register_model
class cswin_base(CSWin):
    def __init__(self, **kwargs):
        super(cswin_base, self).__init__(patch_size=4, embed_dim=96, depth=[2,4,32,2],num_heads=[4,8,16,32],in_chans=3,
                                          split_size =[1,2,7,7], drop_path_rate=0.6, use_chk=False, mlp_ratio=4.,
                                          qkv_bias=True, qk_scale=None, drop_rate=0.,
                                          attn_drop_rate=0.,
                                          )
